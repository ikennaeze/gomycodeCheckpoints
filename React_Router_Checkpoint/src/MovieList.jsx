    ...
    <Card key={movie.title} className='flex flex-col items-center p-4 bg-[#d4dcdc] w-[20%] '>
        <Card.Img src={movie.posterURL} className="w-48 h-48"></Card.Img>
            <Card.Body className='flex flex-col items-center'>
                <Card.Title className=" text-center font-['poppins'] font-bold pt-4"><h2>{movie.title}</h2></Card.Title>
                <Card.Text>
                ...
                <Button className="w-[60%] bg-slate-400 p-2 text-center" href={movie.moviePage}>LEARN MORE</Button>
            </Card.Body>
    </Card>
    ))}
    </div>
